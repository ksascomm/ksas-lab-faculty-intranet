...
register_nav_menus(
	array(
		'main-nav'     => __( 'The Main Menu', 'ksaslab' ),   // Main nav in header
		'footer-links' => __( 'Footer Links', 'ksaslab' ), // Secondary nav in footer
	)
);

// The Top Menu
function ksaslab_top_nav() {
	wp_nav_menu(
		array(
...
// The Off Canvas Menu
function ksaslab_off_canvas_nav() {
	wp_nav_menu(
		array(
			'container'      => false,                           // Remove nav container
...
// The Footer Menu
function ksaslab_footer_links() {
	wp_nav_menu(
		array(
			'container'      => 'false',                              // Remove nav container
			'menu'           => __( 'Footer Links', 'ksaslab' ),     // Nav name
...
function ksaslab_main_nav_fallback() {
	wp_page_menu(
		array(
			'show_home'   => true,
...
function ksaslab_footer_links_fallback() {
